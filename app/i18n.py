...
UI = {
    ...
    "ingots_title": {"fr": "Lingots possibles", "en": "Possible ingots"},
    "ingots_via":   {"fr": "via", "en": "from"},
    ...
    "gmap_labels":  {"fr": "Afficher les noms des systèmes", "en": "Show system names"},
    "gmap_labels_help": {"fr": "Lisible surtout en filtrant un secteur (sinon 596 noms se superposent). Zoome à la molette pour aérer.",
                         "en": "Best with a sector filter on (otherwise 596 names overlap). Scroll to zoom in for clarity."},
