...
UI = {
    ...
    "poi_col_count":{"fr": "Découvertes", "en": "Discoveries"},
    "poi_select":   {"fr": "POI à localiser", "en": "POI to locate"},
    "poi_found":    {"fr": "📍 Découvert sur ces planètes", "en": "📍 Found on these planets"},
    "poi_found_none": {"fr": "Ce POI n'a pas encore été découvert — ajoute-le depuis l'onglet Carte communautaire (section 🏛️ Bases / POI).",
                       "en": "This POI hasn't been discovered yet — add it from the Community map tab (🏛️ Bases / POIs section)."},
